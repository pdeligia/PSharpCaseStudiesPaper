...
The Live Azure Table Migration (MigratingTable) is a library for transparently migrating a data set between tables in an Azure Storage service, while an application is accessing this data set.
