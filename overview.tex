...
The \psharp~\cite{deligiannis2015psharp} framework provides an \emph{event-driven asynchronous programming} language and a \emph{concurrency unit testing} engine for developing highly-reliable distributed systems.
...
The second core component of the \psharp project is a concurrency unit testing engine that is embedded in the \psharp runtime. This engine allows the event schedulings of a \psharp program to be explored in a controlled manner, facilitating deterministic replay of bugs.
