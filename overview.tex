...
Although a significant amount of research has been conducted during the past few decades on how to test distributed systems~\cite{lamport1977proving, lamport1994temporal, schuppan2004efficient, killian2007life, yang2009modist}, it is still not clear how to successfully apply all these promising research techniques in a complex production environment.

Product groups are still using techniques such as unit testing, integration testing and stress testing, which although can catch many bugs, they are not able to catch the most tricky ones.
