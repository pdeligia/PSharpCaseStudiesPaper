...
\subsection*{Abstract}
Testing distributed systems is challenging due to multiple sources of nondeterminism. Conventional testing approaches are ineffective in preventing serious but subtle bugs from reaching production. Advanced industry practice, such as AWS using formal methods~\ref{}, only verifies high level specification and falls short of checking executable code. In this paper, we present a new framework for testing distributed storage systems.
Our approach makes verification techniques for high level specification directly applicable to the executable code.
It therefore significantly improves coverage of important system behaviors and uncovers during testing subtle bugs that are often caught after deployment.
...
The bugs discovered by our method are exhibited by executions with subtle combination of concurrency and failures,
