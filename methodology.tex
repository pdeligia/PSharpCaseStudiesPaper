...
It took less than ten seconds for the \psharp testing engine to report the first occurrence of a liveness bug in vNext (see Section~\ref{sec:eval}). Upon examining the debug trace, the vNext developers were able to confirm the bug.
