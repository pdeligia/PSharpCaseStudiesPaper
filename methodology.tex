...
The \texttt{Environment} is essentially a ``god'' machine: it is the very first machine that is created; has a handle to all other machines in the harness; and includes the logic based on which the test harness will execute (e.g. how many nodes should be created, how many failures should occur, etc).
