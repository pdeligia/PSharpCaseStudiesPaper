...
To solve this problem, and allow \psharp to be used for testing legacy distributed systems, we decided to take a different approach. Our approach of testing existing distributed systems using \psharp requires three key steps:
...
\PDComment{Step 1 and 3 are related and thus could combine, also in the following subsections I present 1 and 3 together as the process of ``modeling of environment''}
