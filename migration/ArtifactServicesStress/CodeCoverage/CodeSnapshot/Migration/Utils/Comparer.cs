...
namespace Migration
{
    ...
    public class BetterComparer : EqualityComparer<object>
    {
        ...
        public static string ToString(object obj)
        {
            ...
            // No way around some mess here.  At least this approach separates
            // the line noise from the behavior.
            if (obj.GetType().IsGenericType && obj.GetType().GetGenericTypeDefinition() == typeofTableQueryGeneric)
            {
                return (string)typeof(BetterComparer).GetMethod(
                    "TableQueryToString", BindingFlags.NonPublic | BindingFlags.Static)
            ...
            if ((entity = obj as ITableEntity) != null)
            {
                ...
                kvps.AddRange(from kvp in entity.WriteEntity(null)
                              orderby kvp.Key
